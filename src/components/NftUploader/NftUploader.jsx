...
const NftUploader = () => {
  ...
  const imageToNFT = async (e) => {
    const API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDJjZDNlODNCNDZlNDMzMTdBNjMwZjQyODI5OTg3MUNFNzc1NTJkNzIiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2NTcwMTIzMTE2NzUsIm5hbWUiOiJBbnlhIn0.-BFsIJpMCqBVw7nijFuYdcTVtIXh46qfhIy7GUHYV6w"
  ...
  const askContractToMintNft = async (ipfs) => {
    const CONTRACT_ADDRESS =
      "0x3a1A1cbaD5C56c8D7a22886384105ED8178F39D1";
    try {
      const { ethereum } = window;
      if (ethereum) {
